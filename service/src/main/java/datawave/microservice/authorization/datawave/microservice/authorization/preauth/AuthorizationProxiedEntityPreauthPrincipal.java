...
public class AuthorizationProxiedEntityPreauthPrincipal extends ProxiedEntityPreauthPrincipal {
    ...
    public AuthorizationProxiedEntityPreauthPrincipal(SubjectIssuerDNPair callerPrincipal, Collection<SubjectIssuerDNPair> proxiedEntities, HttpServletRequest request) {
